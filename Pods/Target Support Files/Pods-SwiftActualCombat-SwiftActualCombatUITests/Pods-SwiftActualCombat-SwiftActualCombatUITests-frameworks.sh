...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PLVMarquee/PLVMarquee.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PLVMasonry/PLVMasonry.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PLVSubtitle/PLVSubtitle.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PLVTimer/PLVTimer.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PLVVodDanmu/PLVVodDanmu.framework"
